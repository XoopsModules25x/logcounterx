...
//	Initial Values
$StepRecNum = 500;
$RecID		= (isset($_GET['rec']) ? intval($_GET['rec']) : 0);
$MaxRecID	= (isset($_GET['max']) ? intval($_GET['max']) : 0);
$TotalRecNum	= (isset($_GET['ttl']) ? intval($_GET['ttl']) : 0);
$PageNum	= (isset($_GET['page']) ? intval($_GET['page']) + 1 : 0);
